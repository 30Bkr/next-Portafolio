...
const ProjectCard = ({imgURL, title, description, gitUrl, previewUrl} : any) => {
  return (
    <div className='z-10'>
      ...
      >
        <div className='overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all'>
