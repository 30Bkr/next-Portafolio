  ...
  return (
    <section className='h-screen pt-24 z-10' id='contact'>
        <div className='flex justify-center items-center mt-20'>
            <form className='z-20 flex flex-col bg-white h-[550px] w-[400px] rounded-xl px-8 py-8' action="">
                <h2 className='w-full flex justify-center items-center'>Contactame</h2>
