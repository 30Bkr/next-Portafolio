    ...
    <section className='text-white h-screen ' id='about'>
        <div className='md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16'>
          ...
          <div className='mt-4 md:mt-0 text-left flex flex-col  w-full h-[642px]'>
            ...
            <p className='text-base lg:text-lg w-auto'>
              Soy una persona comprometida con el trabajo, sociable, pro-activo, deportista y responsable. 
              Apasionado por el deporte, la programacion y el conocimiento. Me gusta aprender cosas nuevas y me gustan los retos.
            </p>
